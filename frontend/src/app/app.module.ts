...
@NgModule({
  declarations: [
    AppComponent, ProductsComponent, HeaderComponent, NavigationComponent, SidebarComponent, SidebarIconComponent, LogoComponent, ProductDetailsComponent, FilterComponent
  ],
  imports: [
